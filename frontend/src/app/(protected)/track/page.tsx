              ...
              <GlassCard className="p-8">
                ...
                <div className="space-y-6">
                  <div className="space-y-2">
                    ...
                    <select 
                      name="subcategory"
                      className="w-full bg-background border border-foreground/10 rounded-lg p-3 text-foreground"
                      defaultValue="car"
                    >
                  ...
                  <div className="flex justify-between mt-4">
                    ...
                    }} className="w-full rounded-2xl py-6 font-medium text-lg">
                      Log Action <ArrowRight className="ml-2 w-5 h-5" />
                    </Button>
                  </div>
                </div>
              </GlassCard>
