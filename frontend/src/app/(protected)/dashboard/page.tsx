...
const EmissionsTrend = dynamic(() => import("@/components/charts/emissions-trend").then(mod => mod.EmissionsTrend), { ssr: false, loading: () => <div className="h-[300px] bg-white/5 animate-pulse rounded-2xl" /> });
const CategoryChart = dynamic(() => import("@/components/charts/category-chart").then(mod => mod.CategoryChart), { ssr: false, loading: () => <div className="h-[300px] bg-white/5 animate-pulse rounded-2xl" /> });
const ScoreCard = dynamic(() => import("@/components/charts/score-card").then(mod => mod.ScoreCard), { ssr: false });
const Timeline = dynamic(() => import("@/components/tracking/timeline").then(mod => mod.Timeline), { ssr: false });
    ...
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "operatingSystem": "Web",
            "description": "Track, analyze, and reduce your carbon footprint with AI-driven insights.",
            "offers": {
              "@type": "Offer",
              "price": "0"
            }
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        ...
        <div className="xl:col-span-2 flex flex-col gap-8">
          ...
          {/* Charts Section */}
          <div>
            <h3 className="text-lg font-semibold text-foreground/80 tracking-tight mb-4 px-2">Analytics</h3>
