  ...
  return (
    <div className="h-[calc(100vh-8rem)] max-w-4xl mx-auto flex flex-col">
      <div className="mb-4">
        ...
        <p className="text-muted-foreground">Get personalized insights and reduction strategies.</p>
      </div>
        ...
        <CardContent className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {isLoading && (
            <div className="flex gap-3 max-w-[80%] mr-auto">
              ...
              <div className="p-3 rounded-xl bg-muted text-foreground rounded-tl-sm flex items-center gap-1">
