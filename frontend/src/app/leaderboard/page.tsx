...
const MOCK_INDIVIDUALS = [
  { id: 1, name: "Sarah Jenkins", trees: 142, trend: "+4%", rank: 1, isMe: false },
  { id: 2, name: "Michael Chang", trees: 128, trend: "+2%", rank: 2, isMe: false },
  { id: 3, name: "You", trees: 115, trend: "+12%", rank: 3, isMe: true },
  { id: 4, name: "Elena Rodriguez", trees: 98, trend: "-1%", rank: 4, isMe: false },
];

export default function LeaderboardPage() {
  const [activeTab, setActiveTab] = useState<"individual" | "team" | "corporate">("team");

  const data = activeTab === "team" ? MOCK_TEAMS : MOCK_INDIVIDUALS;
        ...
        <GlassCard className="p-8 md:p-12 border-primary/20 bg-primary/5 text-center relative overflow-hidden group">
          ...
          <div className="relative z-10 flex flex-col items-center">
            ...
            <h3 className="text-4xl md:text-6xl font-semibold tracking-tight text-foreground leading-tight max-w-2xl">
              This month, the company planted a virtual forest of <span className="text-primary">12,400 trees</span>.
            </h3>
          </div>
        </GlassCard>
      </motion.div>
